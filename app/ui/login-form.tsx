...
export default function LoginForm() {
	...
	const callbackUrl = searchParams.get('callbackUrl') || '/dashboard' //zapisuje skad uzytkownik zostal przekierowany, czyli jezeli chcial sie dostac np. do /dashboard/invoices to po zalogowaniu zostanie tam przekierowany od razu
